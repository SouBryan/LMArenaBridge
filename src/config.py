...
def _apply_config_defaults(config: dict) -> None:
    ...
    config.setdefault("cloakbrowser_proxy_window_mode", constants.DEFAULT_CLOAKBROWSER_PROXY_WINDOW_MODE)
    config.setdefault("cloakbrowser_fetch_window_mode", constants.DEFAULT_CLOAKBROWSER_FETCH_WINDOW_MODE)
...
def get_default_config() -> dict:
    ...
    return {
        ...
        "cloakbrowser_proxy_window_mode": constants.DEFAULT_CLOAKBROWSER_PROXY_WINDOW_MODE,
        "cloakbrowser_fetch_window_mode": constants.DEFAULT_CLOAKBROWSER_FETCH_WINDOW_MODE,
